...
GET_ENVELOPES_BY_BUDGET_ID = "SELECT pk_envelopes_id, name FROM envelopes WHERE fk_budgets_id = %s"
...
GET_RECEIPT_TEMPLATES_AND_PAYMENT_SOURCES_BY_BUDGETS_ID = "SELECT rt.pk_receipt_templates_id, rt.merchant, rt.description, rt.debit_or_credit, ps.name as payment_source_name FROM receipt_templates rt LEFT JOIN payment_sources ps ON ps.pk_payment_sources_id = rt.fk_payment_sources_id WHERE rt.fk_budgets_id = %s"
GET_RECEIPTS_AND_PAYMENT_SOURCES_BY_BUDGETS_ID = "SELECT r.pk_receipts_id, r.merchant, r.debit_or_credit, r.transaction_date, r.amount, ps.name as payment_source_name FROM receipts r LEFT JOIN payment_sources ps ON ps.pk_payment_sources_id = r.fk_payment_sources_id WHERE r.fk_budgets_id = %s"
...
DROP_FROM_TRANSACTIONS_BY_PAYMENT_SOURCES_ID = "DELETE FROM transactions WHERE fk_receipts_id IN (SELECT pk_receipts_id FROM receipts WHERE fk_payment_sources_id = %s)"
DROP_FROM_RECEIPTS_BY_PAYMENT_SOURCES_ID = "DELETE FROM receipts WHERE fk_payment_sources_id = %s"
DROP_FROM_TRANSACTION_TEMPLATES_BY_PAYMENT_SOURCES_ID = "DELETE FROM transaction_templates WHERE fk_receipt_templates_id IN (SELECT pk_receipt_templates_id FROM receipt_templates WHERE fk_payment_sources_id = %s)"
DROP_FROM_RECEIPT_TEMPLATES_BY_PAYMENT_SOURCES_ID = "DELETE FROM receipt_templates WHERE fk_payment_sources_id = %s"
