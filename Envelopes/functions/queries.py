...
GET_RECEIPTS_AND_PAYMENT_SOURCES_BY_BUDGETS_ID = "SELECT r.pk_receipts_id, r.description, r.debit_or_credit, ps.name as payment_source_name FROM receipts r LEFT JOIN payment_sources ps ON ps.pk_payment_sources_id = r.fk_payment_sources_id WHERE r.fk_budgets_id = %s"
